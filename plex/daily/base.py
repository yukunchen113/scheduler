...
def process_daily_lines(datestr: str, lines: list[str]) -> list[str]:
    ...
    new_lines = update_templates_in_file(
        timing_lines + splitter_line + task_lines, datestr=datestr, is_main_file=True
    )
    ...
    return update_taskgroups_in_lines(
